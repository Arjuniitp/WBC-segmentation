...
PATH = "/home/arjun/py_code/skin/test/new_data/"
batch_size = 8
H = 512
W = 512
...
def save_results(ori_x, ori_y, y_pred, save_image_path):
    ...
    cat_images = y_pred*255
    cv2.imwrite(save_image_path, cat_images)
    
if __name__ == "__main__":
    # Dataset
    IMAGE_SIZE = 512
    test_x = sorted(glob(os.path.join(PATH, "/home/arjun/py_code/skin/test/new_data/I/*")))
    test_y = sorted(glob(os.path.join(PATH, "/home/arjun/py_code/skin/test/new_data/M/*")))
    ...
    with CustomObjectScope({'iou': iou, 'dice_coef': dice_coef, 'jacard_coef':jacard_coef}):
        model = tf.keras.models.load_model("/home/arjun/py_code/skin/UNet_skin_bce.h5")
        #model.summary()... 'bce_ft_loss':bce_ft_loss, 'focal_tversky':focal_tversky,
    ...
    for x, y in tqdm(zip(test_x, test_y), total=len(test_x)):
        ...
        save_image_path = f"/home/arjun/py_code/skin/B/{name}"
    ...
    df.to_csv("/home/arjun/py_code/skin/B_score.csv")       
