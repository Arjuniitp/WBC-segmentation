...
if __name__ == "__main__":
    ...
    with CustomObjectScope({'iou': iou, 'dice_coef': dice_coef, 'jacard_coef':jacard_coef}):
        model = tf.keras.models.load_model("/home/arjun/Downloads/UNet_skin_bce.h5")
        #'bce_ft_loss':bce_ft_loss, 'focal_tversky':focal_tversky,
    ...
    df.to_csv("/home/arjun/Downloads/Skin/B_score.csv")
